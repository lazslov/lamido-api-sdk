/**
 * `@lazslov/email/next` — the webhook route handler.
 *
 * @remarks
 ...
 *
 * The whole point of the shape is that {@link createEmailWebhookHandler} **cannot be constructed
...
export { createEmailWebhookHandler, type EmailWebhookHandlerOptions } from "./handler.js";
